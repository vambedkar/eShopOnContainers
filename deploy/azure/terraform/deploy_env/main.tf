...
terraform {
    backend "azurerm" {
        resource_group_name  = "tf_state_storage_neo" #Your tf state resource group name
        storage_account_name = "tfstatestorageaccteus200" #Your unique tf state storage account name
